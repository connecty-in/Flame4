!function (e, t) {
  ...
  return function (e) {
    ...
    (function (e) {
      ...
      function l(e) {
        return e.sendRequest({type: "devices", name: "isMultipleAudioInputSupported"})
      }
    ...
    function s() {
      var e = {methodName: "", fileLocation: "", line: null, column: null}, t = new Error,
    ...
    function o() {
      ...
      if (!(n[t] < e.level)) for (var a = !(e.options.disableCallerInfo || i.disableCallerInfo) && s(), c = r.concat(e.transports), l = 0; l < c.length; l++) {
        var u = c[l], d = u[t];
    ...
    function d(e, t, n, r) {
      var i, s, o, a;
      if (l(n), void 0 === (s = e._events) ? (s = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit("newListener", t, n.listener ? n.listener : n), s = e._events), o = s[t]), void 0 === o) o = s[t] = n, ++e._eventsCount; else if ("function" == typeof o ? o = s[t] = r ? [n, o] : [o, n] : r ? o.unshift(n) : o.push(n), (i = u(e)) > 0 && o.length > i && !o.warned) {
        o.warned = !0;
    ...
    Object.defineProperty(a, "defaultMaxListeners", {
      ...
      if ("function" == typeof c) s(c, this, t); else {
    ...
    e.exports = function (e) {
      var t, n = e.scope, r = e.window, i = e.windowForEventListening || window, s = {}, o = [], a = {}, c = !1,
        l = function (e) {
          var t;
          try {
            t = JSON.parse(e.data)
    ...
    var r = n(1), i = n(7), s = {}, o = [], a = r.levels.TRACE;
    e.exports = {
    ...
    i.prototype.stringify = function (e) {
      ...
      if (t) {
        ...
        r === t ? n.count += 1 : (this.queue.push({text: t, timestamp: e, count: 1}), this.totalLen += t.length)
      }
    ...
    function s(e, t = !1, n = "hash") {
      const r = "search" === n ? e.search : e.hash, i = {}, s = r && r.substr(1).split("&") || [];
      if ("hash" === n && 1 === s.length) {
        const e = s[0];
        if (e.startsWith("/") && 1 === e.split("&").length) return i
      }
      return s.forEach(e => {
        const n = e.split("="), r = n[0];
        if (!r) return;
        let s;
        try {
          if (s = n[1], !t) {
    ...
    function c(e) {
      const t = {toString: l};
      let n, r, i;
      if (e = e.replace(/\s/g, ""), n = new RegExp("^([a-z][a-z0-9\\.\\+-]*:)", "gi"), r = n.exec(e), r && (t.protocol = r[1].toLowerCase(), e = e.substring(n.lastIndex)), n = new RegExp("^(//[^/?#]+)", "gi"), r = n.exec(e), r) {
        let i = r[1].substring(2);
        e = e.substring(n.lastIndex);
        const s = i.indexOf("@");
        -1 !== s && (i = i.substring(s + 1)), t.host = i;
        const o = i.lastIndexOf(":");
        -1 !== o && (t.port = i.substring(o + 1), i = i.substring(0, o)), t.hostname = i
      }
      if (n = new RegExp("^([^?#]*)", "gi"), r = n.exec(e), r && (i = r[1], e = e.substring(n.lastIndex)), i ? i.startsWith("/") || (i = "/" + i) : i = "/", t.pathname = i, e.startsWith("?")) {
        let n = e.indexOf("#", 1);
        -1 === n && (n = e.length), t.search = e.substring(0, n), e = e.substring(n)
      } else t.search = "";
      return t.hash = e.startsWith("#") ? e : "", t
    }

    function l(e) {
      const {hash: t, host: n, pathname: r, protocol: i, search: s} = e || this;
      let o = "";
    ...
    function u(e) {
      ...
      if (!n.host) {
        ...
        if (t) {
          const {host: e, hostname: i, pathname: s, port: a} = c(o("org.jitsi.meet://" + t));
      ...
      if (s) {
        let {search: e} = n;
        -1 === e.indexOf("?jwt=") && -1 === e.indexOf("&jwt=") && (e.startsWith("?") || (e = "?" + e), 1 === e.length || (e += "&"), e += "jwt=" + s, n.search = e)
      }
      let {hash: l} = n;
    ...
    class m {
      ...
      _onMessageReceived(e) {
        if ("response" === e.type) {
          ...
          this._backend.send({type: "response", error: n, id: e.id, result: t})
    ...
    const g = s(window.location).jitsi_meet_external_api_id, y = {};
    let _;
    "number" == typeof g && (y.scope = "jitsi_meet_external_api_" + g), (window.JitsiMeetJS || (window.JitsiMeetJS = {}), window.JitsiMeetJS.app || (window.JitsiMeetJS.app = {}), window.JitsiMeetJS.app).setExternalTransportBackend = e => _.setBackend(e);
    var b = n(4), w = n(0);
    ...
    const x = ["css/all.css", "libs/alwaysontop.min.js"], j = {
    ...
    function I(e, t = {}) {
      return u(function (e) {
        ...
        return e
      }({}, t, {url: `${t.noSSL ? "http" : "https"}://${e}/#jitsi_meet_external_api_id=${C}`}))
    }
    ...
    class R extends i.a {
      constructor(e, ...t) {
        super();
        const {roomName: n = "", width: r = "100%", height: i = "100%", parentNode: s = document.body, configOverwrite: o = {}, interfaceConfigOverwrite: a = {}, noSSL: c = !1, jwt: l, onload: u, invitees: d, devices: h, userInfo: p, e2eeKey: f} = function (e) {
          if (!e.length) return {};
          switch (typeof e[0]) {
            case"string":
            case void 0: {
        ...
        this._parentNode = s, this._url = I(e, {
          configOverwrite: o,
          ...
          devices: h,
          userInfo: p
        }), this._createIFrame(i, r, u), this._transport = new m({
          backend: new v({
            postisOptions: {
        ...
        }), Array.isArray(d) && d.length > 0 && this.invite(d), this._tmpE2EEKey = f, this._isLargeVideoVisible = !0, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), C++
      }
      ...
      _setupListeners() {
        this._transport.on("event", e => {
          let {name: t} = e, n = L(e, ["name"]);
          const r = n.id;
          switch (t) {
            case"video-conference-joined":
              void 0 !== this._tmpE2EEKey && (this.executeCommand(j.e2eeKey, this._tmpE2EEKey), this._tmpE2EEKey = void 0), this._myUserID = r, this._participants[r] = {avatarURL: n.avatarURL};
            case"participant-joined":
              this._participants[r] = this._participants[r] || {}, this._participants[r].displayName = n.displayName, this._participants[r].formattedDisplayName = n.formattedDisplayName, S(this, 1);
              break;
      ...
      executeCommand(e, ...t) {
        e in j ? this._transport.sendEvent({data: t, name: j[e]}) : console.error("Not supported command name.")
      }
      ...
      sendProxyConnectionEvent(e) {
        this._transport.sendEvent({data: [e], name: "proxy-connection-event"})
      }
